...
// Vendored from Deformable-DETR (https://github.com/fundamentalvision/Deformable-DETR)
// via LW-DETR (https://github.com/Atten4Vis/LW-DETR). Adapted to register against
// the torchvision dispatcher and to use current libtorch tensor APIs.
